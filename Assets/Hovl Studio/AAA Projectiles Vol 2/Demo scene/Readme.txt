...
3)Scripts
3.1)"HS_AutoDestroyPS" is needed to destroy parts of the effects through a lifetime in the particle system.
    If you want projectiles to exist on the scene longer - just increase the Duration and Lifetime!
3.2)"HS_ProjectileMover" is created for demonstration purposes only. The main product that you buy is effects.
